            ...
            <div class="modal-dialog" permission="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <x-text-field type="date" min="{{date('Y-m-d')}}" name="tanggal" label="Tanggal" />
                        <x-text-field type="time" name="waktu" label="Waktu" />
                        <x-text-field type="number" name="kuota_tersedia" label="Kuota tersedia" />
                    </div>
