<div class="page-inner">
    <div class="row">
                ...
                <div class="card-body">
                    <h4 class="card-title text-capitalize">
                        <a href="{{route('dashboard')}}">
                            <span><i class="fas fa-arrow-left mr-3 text-capitalize"></i>data umat</span>
                        </a>
        ...
        <div class="col-md-12">
            <livewire:table.data-umat-table />
        </div>
            ...
            <div class="modal-dialog" permission="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <x-text-field type="text" name="nama_lengkap" label="Nama lengkap" />
                        <x-text-field type="date" name="tanggal_lahir" label="Tanggal lahir" />
                        <x-textarea type="textarea" name="alamat" label="Alamat" />
                        <x-text-field type="text" name="linkungan" label="Linkungan" />
                        <x-text-field type="text" name="wilayah" label="Wilayah" />
